  ...
  return (
    <>
      ...
      <main className="bg-[#F8F8F8]">
        ...
        <div className="container grid grid-cols-2 gap-6 py-6 sm:grid-cols-3 md:grid-cols-2 lg:grid-cols-3 lg:gap-12 lg:py-12">
        ...
        <div className="mt-8 bg-white">
          ...
          <div className="container flex gap-8 overflow-auto pb-8 md:justify-center">
            ...
            <div className="max-w-xs shrink-0 rounded-xl bg-[#F3F3F3]">
        ...
        <div className="relative mt-8 hidden overflow-hidden bg-white md:block">
          <div className="container flex">
            <div className="flex w-1/2 flex-col justify-center px-4">
              ...
              <div className="mt-12 flex max-w-md rounded-lg border-2 border-primary">
